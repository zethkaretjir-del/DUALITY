...
def matrix_rain(duration=8, fall_speed=1.5):
    ...
    CYAN_DARK = '\033[36m'      # Cyan gelap (ekor)
        ...
        while time.time() < end_time:
            ...
            for x in range(columns):
                ...
                for i in range(data['length']):
                    ...
                    if 0 <= y < rows:
                        if i == 0:
                            frame[y][x] = f"{CYAN_BRIGHT}{random.choice(chars)}\033[0m"
                        else:
                            frame[y][x] = f"{CYAN_DARK}{random.choice(chars)}\033[0m"
    ...
    print("\n" * rows)
    os.system('clear')
    print(f"\033[96m✨ Matrix rain selesai! ✨\033[0m")

if __name__ == "__main__":
    print(f"\033[96m[*] Memulai animasi Matrix rain cyan...\033[0m")
    print(f"\033[96m[*] Durasi: 8 detik\033[0m")
    print(f"\033[96m[*] Kecepatan jatuh: 1.5x lebih cepat\033[0m")
    time.sleep(1)
